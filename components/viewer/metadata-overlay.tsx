  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-10 select-none font-mono text-foreground">
      ...
      <div className="absolute left-2 top-2 space-y-0.5">
        <p className="pacs-tag text-[10px] font-semibold">{study.patientName}</p>
      ...
      <div className="absolute right-2 top-2 space-y-0.5 text-right">
        <p className="pacs-tag text-[10px] font-semibold">RSUD Dr. Saiful Anwar</p>
        <p className="pacs-tag text-[9px]">
          {study.modality}
          <span className="mx-1 opacity-40">·</span>
          {study.studyDescription}
        </p>
        <p className="pacs-tag text-[9px]">{study.bodyPart}</p>
      </div>
